...
/**
 * 商品发布信息 Created by HDL on 2016/4/17.
 */
public class GoodsPublishInfo implements Serializable {
	...
	public String toString() {
		return "GoodsPublishInfo [gTitle=" + gTitle + ", gClassify="
				+ gClassify + ", gImgs_list=" + gImgs_list + ", gPrice="
				+ gPrice + ", gOldPrice=" + gOldPrice + ", gDesc=" + gDesc
				+ ", isPinkage=" + isPinkage + ", isUrgent=" + isUrgent
				+ ", gAddress=" + gAddress + ", gDeadline=" + gDeadline
	...
	public GoodsPublishInfo(String gTitle, String gClassify,
			ArrayList<String> gImgs_list, int gPrice, int gOldPrice,
			String gDesc, boolean isPinkage, boolean isUrgent, String gAddress,
			String gDeadline) {
		this.gTitle = gTitle;
		this.gClassify = gClassify;
		this.gImgs_list = gImgs_list;
